...
const sequelize = new Sequelize(
  ...
  "myuser", //Username (i guess the one which we had in postress, that is the username and password for access to the database)
  "12345678", //password for the username "admin" for access to the databse
  {
    host: "localhost",
